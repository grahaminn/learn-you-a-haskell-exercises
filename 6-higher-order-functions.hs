...
higherOrderSequenceApplication operator base mapFunction a b = foldl operator base (map mapFunction [a..b])

-- Define a factorial method using the higherOrderSequenceAppliction
hoFactorial :: Int -> Int
hoFactorial a = higherOrderSequenceApplication (*) 1 (\x -> x) 1 a 
